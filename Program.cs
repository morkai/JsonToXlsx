...
namespace JsonToXlsx
{
    class Config
    {
        ...
        public XLWorkbook CreateWorkbook()
        {
            ...
            if (SubHeader)
            {
                ...
                subHeaderRow.Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Center;
                subHeaderRow.Style.Alignment.Vertical = XLAlignmentVerticalValues.Center;
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            wb.SaveAs(Console.OpenStandardOutput());
